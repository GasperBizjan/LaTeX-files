...
\newcommand{\myname}{\textbf{JOHN DOE}} % Your name (e.g. "John Smith")
...
% Subject
\newcommand{\subject}{\textbf{Subject:} Application for Microsoft employment} % the subject of the cover letter
